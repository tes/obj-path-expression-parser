const { customFragment, escapedFragment, pathExpression,
  pathExpressions, unescapedFragment } = require('./parser/grammar');
...
function *expandFromATS(ats, obj) {
  let iterPath;
